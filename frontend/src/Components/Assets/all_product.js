...
let all_product = [
    {
        id:1,
        name:" Comet Aeon v2 Mango Chilli",
        category:"men",
        image: p1_img,
        new_price:55.61,
        old_price:67.45,
    ...
    {
        id:3,
        name:" Adidas Originals Forum Low CL",
        category:"men",
        image:p3_img,
        new_price:124.86,
        old_price:130.27,
    ...
    {
        id:11,
        name:"X Lows MONOPOLY Standard Edition",
        category:"men",
        image: p11_img,
        new_price:59.76,
        old_price:66.48,
    ...
    {
        id:14,
        name:"Women Wicked Brothers Cherry Red Sneakers",
        category:"women",
        image: p14_img,
        new_price:27.95,
        old_price:36.42,
    ...
    {
        id:18,
        name:"Tommy Hilfiger Solid Sneakers",
        category:"women",
        image: p18_img,
        new_price:106.68,
        old_price:111.55,
    ...
    {
        id:19,
        name:"Gully Number 001 - DVAITA Calico White",
        category:"women",
        image: p19_img,
        new_price:101.09,
        old_price:109.22,
    ...
    {
        id:25,
        name:"Sparkly Princess Bling Walking Sneaker",
        category:"kids",
        image: p25_img,
        new_price:114.42,
        old_price: 121.72,
    ...
    {
        id:28,
        name:"Side Zipper Cute Ankle Boots",
        category:"kids",
        image:p28_img,
        new_price:161.69,
        old_price: 170.28,
    ...
    {
        id:29,
        name:"Athlo Running Tennis Shoes",
        category:"kids",
        image:p29_img,
        new_price:163.70,
        old_price:168.11,
    ...
    {
        id:30,
        name:"Zepron Zipper Ankle Boots",
        category:"kids",
        image:p30_img,
        new_price:147.10,
        old_price:152.99,
    ...
    {
        id:32,
        name:"Cheerleading Sneaky Shoes",
        category:"kids",
        image:p32_img,
        new_price:154.36,
        old_price:160.55,
    ...
    {
        id:33,
        name:"Zoroadke Strapy Canvas Shoes",
        category:"kids",
        image:p33_img,
        new_price:151.08,
        old_price:156.66,
    ...
    {
        id:36,
        name:"Blary Mary Jane White Sneaker",
        category:"kids",
        image:p36_img,
        new_price:117.75,
        old_price:122.38,
